...
ToggleButton.TextSize = 24 -- ใช้ TextSize แทน TextScaled เพื่อให้รองรับ Arceus X
...
-- โหมดเทพ (ปรับให้เรียบง่ายสำหรับ Arceus X)
...
-- ฟังก์ชันปิด/เปิด UI (ลดแอนิเมชัน)
