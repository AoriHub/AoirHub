...
-- === เพิ่ม UI สำหรับเช็คพิกัด ===
local positionFrame = Instance.new("Frame")
positionFrame.Size = UDim2.new(0, 400, 0, 250)
positionFrame.Position = UDim2.new(0.5, -200, 0.5, -125)
positionFrame.AnchorPoint = Vector2.new(0.5, 0.5)
positionFrame.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
positionFrame.BackgroundTransparency = 0.1
...
scrollFrame.Parent = positionFrame

-- ปุ่มเปิดดูพิกัด
local checkPosButton = Instance.new("TextButton")
checkPosButton.Size = UDim2.new(1, -20, 0, 40)
checkPosButton.Position = UDim2.new(0, 10, 0, 10)
checkPosButton.Text = "เปิดดูพิกัด"
checkPosButton.BackgroundColor3 = Color3.fromRGB(70, 130, 180)
checkPosButton.TextColor3 = Color3.new(1, 1, 1)
checkPosButton.Font = Enum.Font.SourceSansBold
checkPosButton.TextSize = 24
checkPosButton.Parent = scrollFrame

-- แสดงพิกัดกลางจอ (บนสุด)
local coordLabel = Instance.new("TextLabel")
coordLabel.Size = UDim2.new(0, 300, 0, 30)
coordLabel.Position = UDim2.new(0.5, -150, 0, 20)
coordLabel.BackgroundTransparency = 1
coordLabel.TextColor3 = Color3.new(1, 1, 1)
coordLabel.Font = Enum.Font.SourceSans
coordLabel.TextSize = 20
coordLabel.Text = "ตำแหน่ง: N/A"
coordLabel.Visible = false
coordLabel.Parent = screenGui

-- ช่องกรอกพิกัด
local coordInput = Instance.new("TextBox")
coordInput.Size = UDim2.new(1, -20, 0, 40)
coordInput.Position = UDim2.new(0, 10, 0, 60)
coordInput.PlaceholderText = "กรอกพิกัด x,y,z เช่น 100,50,200"
coordInput.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
coordInput.TextColor3 = Color3.new(0, 0, 0)
coordInput.Font = Enum.Font.SourceSans
coordInput.TextSize = 20
coordInput.Parent = scrollFrame

-- เมื่อกดปุ่มให้แสดงพิกัด
checkPosButton.MouseButton1Click:Connect(function()
    local char = player.Character
    if char and char:FindFirstChild("HumanoidRootPart") then
        local pos = char.HumanoidRootPart.Position
        coordLabel.Text = string.format("ตำแหน่ง: X: %.2f, Y: %.2f, Z: %.2f", pos.X, pos.Y, pos.Z)
